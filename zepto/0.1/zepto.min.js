...
var Zepto = function() {
    ...
    function l(t) {
        return t in A ? A[t] : A[t] = RegExp("(^|\\s)" + t + "(\\s|$)")
    }
    ...
    return B.matches = function(t, e) {
        ...
        var i, r, a;
        return R.test(t) && (i = E(M.createElement(RegExp.$1))), i || (t.replace && (t = t.replace(Z, "<$1></$2>")), e === b && (e = $.test(t) && RegExp.$1), e in U || (e = "*"), a = U[e], a.innerHTML = "" + t, i = E.each(N.call(a.childNodes), function() {
            a.removeChild(this)
        ...
        if (!t) return B.Z();
        if ("string" == typeof t)
            if (t = t.trim(), "<" == t[0] && $.test(t)) i = B.fragment(t, RegExp.$1, n), t = null;
            else {
                ...
                else if ($.test(t)) i = B.fragment(t.trim(), RegExp.$1, n), t = null;
                else {
                    if (n !== b) return E(n).find(t);
                    i = B.qsa(M, t)
                }
        ...
        var n, r = "#" == e[0],
            ...
            a = r || o ? e.slice(1) : e,
            s = X.test(a);
        return i(t) && s && r ? (n = t.getElementById(a)) ? [n] : [] : 1 !== t.nodeType && 9 !== t.nodeType ? [] : N.call(s && !r ? o ? t.getElementsByClassName(a) : t.getElementsByTagName(e) : t.querySelectorAll(e))
        ...
        parent: function(t) {
            return m(P(this.pluck("parentNode")), t)
        },
        children: function(t) {
        ...
        data: function(t, e) {
            var n = this.attr("data-" + t.replace(_, "-$1").toLowerCase(), e);
            return null !== n ? x(n) : b
        },
        val: function(t) {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var t = this.offsetParent || M.body; t && !k.test(t.nodeName) && "static" == E(t).css("position");) t = t.offsetParent;
                return t
            })
        }
    ...
    }), B.Z.prototype = E.fn, B.uniq = P, B.deserializeValue = x, E.zepto = B, E
}();
...
function(t) {
    ...
    t.active = 0, t.ajaxJSONP = function(e, n) {
        ...
        if (n.xhrFields)
            for (g in n.xhrFields) b[g] = n.xhrFields[g];
...
function(t, e) {
    ...
    t.each(m, function(t, n) {
        ...
        return b = function(n) {
            ...
            P = !0, t(this).css(x), m && m.call(this)
